...
async function createTableHeader(table) {
  ...
  let listth = document.createElement('th');
  listth.innerText = 'List';
  ...
  tr.append(listth,countryth,abbreviationth,capitalth,continentth);
  table.append(tr);
  console.log(table);
}
